#ifndef UNITY_MAGICBYTE_AREA_LIGHTING_INCLUDED
#define UNITY_MAGICBYTE_AREA_LIGHTING_INCLUDED
...
#else
    #if 0 // Ref: Area Light Sources for float-Time Graphics, page 4 (1996).
...
// See "float-Time Area Lighting: a Journey from Research to Production", slide 102.

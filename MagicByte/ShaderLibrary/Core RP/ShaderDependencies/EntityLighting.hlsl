#ifndef UNITY_MAGICBYTE_ENTITY_LIGHTING_INCLUDED
#define UNITY_MAGICBYTE_ENTITY_LIGHTING_INCLUDED
...
float3 SampleSingleLightmap(TEXTURE2D_LIGHTMAP_PARAM(lightmapTex, lightmapSampler), LIGHTMAP_EXTRA_ARGS, float4 transform, bool encodedLightmap, float4 decodeInstructions)
{
...
// Just a shortcut that call function above
float3 SampleDirectionalLightmap(TEXTURE2D_LIGHTMAP_PARAM(lightmapTex, lightmapSampler), TEXTURE2D_LIGHTMAP_PARAM(lightmapDirTex, lightmapDirSampler), LIGHTMAP_EXTRA_ARGS, float4 transform,

Shader "Magic Byte/Vertex Paint" {
	/*
	...
	*/
	Properties {
		...
		_RedMap("Red Map", 2D) = "white" {}
		_GreenMap("Green Map", 2D) = "white" {}
		_BlueMap("Blue Map", 2D) = "white" {}
		[NoScaleOffset] _SmoothnessNormal("Smoothness Normal", 2D) = "bump" {}
	...
	*/
	...
	SubShader {
		...
		Pass {
			...
			#include "VertexPaintPass.hlsl" //Enter the name of your Pass file
			ENDHLSL
		}

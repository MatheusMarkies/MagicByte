Shader "Magic Byte/Hair" {
	...
	Properties {
		...
		_HairLightRamp("Light Ramp", 2D) = "white" {}
		...
		_SecondAnisotropicColor("Hair Anisotropic Color 2", Color) = (0.5, 0.5, 0.5, 1.0)
		_specularIntensity("Hair Specular Intensity", Range(0,2)) = 0.6

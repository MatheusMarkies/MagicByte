Shader "Magic Byte/Iridescence" {
	...
	Properties {
		...
		_IridescenceThickness("Iridescence Thickness", Range(0,1)) = 0.3
		_IridescenceTile("Iridescence Tile", Range(0,10)) = 5

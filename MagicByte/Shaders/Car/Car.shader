Shader "Magic Byte/Car" {
	...
	*/
	Properties {
		...
		[NoScaleOffset] _FlakesMap("Flakes Map", 2D) = "bump" {}
		_FlakesStrength("Flakes Strength", Range(0, 1)) = 1
		_TillingFlakes("Tilling Flakes", Vector) = (100, 100, 0, 0)
		...
		_IOR("IOR", Range(0.1, 10)) = 1.4

		_ClearCoatRoughness("Coat Roughness", Range(0, 1)) = 1
		_ClearCoat("ClearCoat Intensity", Range(0, 1)) = 0.2
	...
	*/
	...
	SubShader {
		...
		Pass {
			...
			#include "CarPass.hlsl" //Enter the name of your Pass file
			ENDHLSL
		}
